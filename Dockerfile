...
# docker build ./ -t rz-ent-chatbot-azure-openai:0.3
# docker run -it --name ent-chatbot-azure-openai -p80:80 rz-ent-chatbot-azure-openai:0.3

# "login to Azure Container Registry"
# docker login -u <user> -p <password> acr0612.azurecr.cn
# "create a new tag for a Docker image with repository name"
# docker tag rz-ent-chatbot-azure-openai:0.3 acr0612.azurecr.cn/rz-ent-chatbot-azure-openai:0.3
# "push a Docker image to a container registry"
# docker push acr0612.azurecr.cn/rz-ent-chatbot-azure-openai:0.3

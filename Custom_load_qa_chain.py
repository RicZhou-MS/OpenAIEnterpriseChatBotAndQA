...
def _load_stuff_chain(
    ...
    **kwargs: Any,
    ...
    _prompt = question_prompt or STUFF_PROMPT_SELECTOR.get_prompt(llm)
    llm_chain = LLMChain(
...
def _load_map_reduce_chain(
    ...
    **kwargs: Any,
    ...
    _question_prompt = (
        question_prompt or MAP_REDUCE_QUESTION_PROMPT_SELECTOR.get_prompt(
            llm)
    )
    _combine_prompt = (
        combine_prompt or MAP_REDUCE_COMBINE_PROMPT_SELECTOR.get_prompt(
            llm)
    )
    map_chain = LLMChain(
        llm=llm,
...
def _load_refine_chain(
    ...
    **kwargs: Any,
    ...
    _question_prompt = (
        question_prompt or REFINE_QUESTION_PROMPT_SELECTOR.get_prompt(
            llm)
    )
    _refine_prompt = refine_prompt or REFINE_REFINE_PROMPT_SELECTOR.get_prompt(
        llm
    )
